...
<section className="bg-white py-16">
  ...
  <Swiper
    ...
    spaceBetween={20}
    slidesPerView={3} // Show 3 at a time like in the reference
  ...
  >
    {[
       { src: "/images/cupcakes.jpg", title: "Cupcakes", path: "/cupcakes" },
      { src: "/images/Crispy.jpg", title: "Crisps", path: "/crisps" },
      { src: "/images/Brownie1.jpg", title: "Brownies", path: "/brownies" },
      { src: "/images/gummies1.jpg", title: "Gummies", path: "/gummies" },
    ].map((cat, idx) => (
      <SwiperSlide key={idx}>
